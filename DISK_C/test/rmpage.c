	...
	while (1)
	{
		...
		if (MouseX > 480 && MouseX < 600 && MouseY>400 && MouseY < 470)//"我的"框判定
		{
			if (mouse_press(480, 400, 600, 470) == 2)
			{
				...
				{
					MouseS = 1;
					lightbutton_rmpage(480, 400, 600, 470, LIGHTMAGENTA, LIGHTGRAY, 1);//color1为线颜色，color2为填充色
					num = 1;
				}
				continue;
			}
		...
		if (MouseX > 590 && MouseX < 640 && MouseY>0 && MouseY < 50)//返回按钮
		{
			if (mouse_press(590, 0, 640, 50) == 2)
			{
				...
				{
					MouseS = 1;
					lightbutton_rmpage(590, 0, 640, 50, RED, LIGHTGRAY, 2);
					num = 2;
				}
				continue;
			}
		...
		if (MouseX > 95 && MouseX < 180 && MouseY>35 && MouseY < 75)//全部
		{
			if (mouse_press(95, 35, 180, 75) == 2)
			{
				...
				{
					MouseS = 1;
					lightbutton_rmpage(95, 35, 180, 75, LIGHTRED, LIGHTGRAY, 3);
					num = 3;
				}
				continue;
			}
		...
		if (MouseX > 205 && MouseX < 290 && MouseY>35 && MouseY < 75)//推荐
		{
			if (mouse_press(205, 35, 290, 75) == 2)
			{
				...
				{
					MouseS = 1;
					lightbutton_rmpage(205, 35, 290, 75, LIGHTRED, LIGHTGRAY, 4);
					num = 4;
				}
				continue;
			}
		...
		if (MouseX > 315 && MouseX < 400 && MouseY>35 && MouseY < 75)//番剧
		{
			if (mouse_press(315, 35, 400, 75) == 2)
			{
				...
				{
					MouseS = 1;
					lightbutton_rmpage(315, 35, 400, 75, LIGHTRED, LIGHTGRAY, 5);
					num = 5;
				}
				continue;
			}
		...
		if (MouseX > 40 && MouseX < 160 && MouseY>400 && MouseY < 470)//主页
		{
			if (mouse_press(40, 400, 160, 470) == 2)
			{
				...
				{
					MouseS = 1;
					lightbutton_rmpage(40, 400, 160, 470, LIGHTMAGENTA, LIGHTGRAY, 6);
					num = 6;
				}
				continue;
			}
